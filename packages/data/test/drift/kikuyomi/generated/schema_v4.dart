...
class Repositories extends Table
    with TableInfo<Repositories, RepositoriesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  Repositories(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  @override
  RepositoriesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  Repositories createAlias(String alias) {
    return Repositories(attachedDatabase, alias);
  }
...
class RepositoriesData extends DataClass
    implements Insertable<RepositoriesData> {
  final int id;
  final String url;
  final String name;
  ...
  factory RepositoriesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  RepositoriesData copyWithCompanion(RepositoriesCompanion data) {
    return RepositoriesData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('RepositoriesData(')
          ..write('id: $id, ')
          ..write('url: $url, ')
          ..write('name: $name, ')
...
class RepositoriesCompanion extends UpdateCompanion<RepositoriesData> {
  final Value<int> id;
  ...
  RepositoriesCompanion.insert({
    ...
    this.lastFetchedAt = const Value.absent(),
       ...
       publicKey = Value(publicKey),
       fingerprint = Value(fingerprint);
  static Insertable<RepositoriesData> custom({
    Expression<int>? id,
...
class DatabaseAtV4 extends GeneratedDatabase {
  ...
  late final Repositories repositories = Repositories(this);
