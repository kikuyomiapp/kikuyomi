...
|---|---|---|---|
| [0001](0001-script-engine-binding.md) | QuickJS binding for the extension runtime | 2 | Accepted |
...
| [0017](0017-installing-extensions-from-a-folder.md) | Installing extensions from a folder | — | Accepted |

Every decision in §9 of `docs/architecture.md` now has an ADR, and all are Accepted: ADR-0001,
the last, once its probe passed on Android emulators in CI. ADR-0016 and ADR-0017 are decisions made
after Phase 0, not ones of §9's.
