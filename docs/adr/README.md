...
Every decision in §9 of `docs/architecture.md` now has an ADR. ADR-0001 is the only one
still Proposed: it awaits an Android run, which is blocked on the emulator hypervisor driver.
